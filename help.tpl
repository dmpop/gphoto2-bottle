...
<div id="content">
    ...
    <p class="mono">To run a user-defined command, specify the desired command in the <em>Command</em> field and press the <strong>Command</strong> button.</p>
    <p class="mono">Press <strong>Stop</strong> to terminate the app.</p>
    <p class="mono">Press <strong>Shutdown</strong> to shut down the server.</p>
</div>
</html>
